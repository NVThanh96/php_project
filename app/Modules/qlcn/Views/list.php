                        ...
                        <?php if (isset($list_nhan_vien)): ?>
                            <?php foreach ($list_nhan_vien as $key => $value): ?>
                                <?php if ($value['flag_delete'] == 1): ?>
                                    ...
                                    <div class="popup" id="popup-<?php echo $value['id'] ?>" hidden="<?php echo $node['isHidden']?>">
                                        <div class="popup-content">
                                            <div class="container custom-container">

                                                <h1 style="color: grey;"><?php echo $node['moTa']; ?></h1>
                                                <h4 style="color: blue;">Nhân viên số: <?php echo $key + 1 ?></h4>
                                                <h4 style="color: green;">Tên nhân viên:<?php echo $value['ten_nhan_vien']; ?></h4>
                                                <h4 style="color: red;">Tuổi: <?php echo $value['tuoi']; ?></h4>
                                                <h4 style="color: orange;">Giới tính: <?php echo $value['gioi_tinh']; ?></h4>
                                                <h4 style="color: purple;">Địa chỉ: <?php echo $value['dia_chi']; ?></h4>
                                                <h4 style="color: teal;">Ngày vào làm: <?php echo date('d/m/Y', strtotime($value['ngay_vao_lam'])); ?></h4>
                                                <h4 style="color: brown;">Lương: <?php echo number_format($value['luong'], 0, ',', '.') . ' VND'; ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif; ?>
