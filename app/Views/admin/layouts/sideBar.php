...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/Public/dist/img/mypic.png"
                ...
                <?php foreach ($readFileJson as $child) : ?>
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach ($child['children'] as $child1) : ?>
                                <?php if($child1['isHidden'] == false): ?>
                                <li class="nav-item">
                                    <a href="<?php echo $child1['activeMenu']; ?>" class="nav-link">
                                        ...
                                        <ul class="nav nav-treeview">
                                            <?php foreach ($child1['children'] as $child2) : ?>
                                                <li class="nav-item">
                                                    ...
                                                    <a href="<?php echo $child2['activeMenu']??''; ?>" class="nav-link">
                                                    ...
                                                    <?php if (isset($child2['children']) && !empty($child2['children'])) : ?>
                                                        <ul class="nav nav-treeview">
                                                            <?php foreach ($child2['children'] as $child3) : ?>
                                                                <li class="nav-item">
                                                                    <a href="<?php echo $child3['activeMenu']??''; ?>" class="nav-link">
